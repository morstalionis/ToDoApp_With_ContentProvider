...
public class Fragment_Pending extends Fragment implements Class_Interface {
    ...
    ArrayList<String> task_id, task_title, task_details, task_date, task_mod;
    ...
    public void onResume() {
        ...
        adapter_pending = new Class_Adapter(getContext(), task_id, task_title, task_date, task_mod, task_details, this);
    ...
    void complete(int position){
        ...
        add_db.c_add_task(txt_taskTitle.toString().trim(), txt_taskCreationDate.toString().trim(), modified.toString().trim(), txt_taskDetail.toString().trim());
    }
